...
<div class="cagegoryCon clearfix">
  <?php if(is_array($tree)): foreach($tree as $key=>$tre): if($tre['parent_id'] == 0): ?><dl>
    <dt><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$tre['cat_id']));?>"><?php echo ($tre['cat_name']); ?></a></dt>
    <dd class="clearfix"> 
      <?php if(is_array($tree)): foreach($tree as $key=>$tr): if($tr['parent_id'] == $tre['cat_id']): ?><p class=""><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$tr['cat_id']));?>" title="CDMA手机" class="txtdot"><?php echo ($tr['cat_name']); ?></a></p><?php endif; endforeach; endif; ?>     
    </dd>
...
<div class="recommendContent entry-content" id="show_hot_area">
  <?php if(is_array($is_hot)): foreach($is_hot as $key=>$list): ?><div class="goodsbox1">
        <div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>"><img src="<?php echo ($list['goods_img']); ?>" alt="<?php echo ($list['goods_name']); ?>"></a>
        </div>
       <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>" title="<?php echo ($list['goods_name']); ?>"><?php echo ($list['goods_name']); ?></a><br>
              <font class="goodspice market"><?php echo ($list['shop_price']); ?></font>
             <b class="f1"><?php echo ($list['market_price']); ?></b><br>
...
<div class="recommendContent entry-content" id="show_best_area">
      <?php if(is_array($is_best)): foreach($is_best as $key=>$list): ?><div class="goodsbox1">
        <div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>"><img src="<?php echo ($list['goods_img']); ?>" alt="<?php echo ($list['goods_name']); ?>"></a></div>
       <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>" title="<?php echo ($list['goods_name']); ?>"><?php echo ($list['goods_name']); ?></a><br>
              <font class="goodspice market"><?php echo ($list['shop_price']); ?></font>
             <b class="f1"><?php echo ($list['market_price']); ?>/b><br>      
      </div><?php endforeach; endif; ?>
...
<div class="recommendContent entry-content" id="show_new_area">
      <?php if(is_array($is_new)): foreach($is_new as $key=>$list): ?><div class="goodsbox1">
        <div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>"><img src="<?php echo ($list['goods_img']); ?>" alt="<?php echo ($list['goods_name']); ?>"></a></div>
       <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$list['goods_id']));?>" title="<?php echo ($list['goods_name']); ?>"><?php echo ($list['goods_name']); ?></a><br>
              <font class="goodspice market"><?php echo ($list['shop_price']); ?></font>
             <b class="f1"><?php echo ($list['market_price']); ?></b><br>      
