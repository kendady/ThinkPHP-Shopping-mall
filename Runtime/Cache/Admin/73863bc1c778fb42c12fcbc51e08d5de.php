...
<table cellpadding="3" cellspacing="1">
  ...
  <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
      <tr>
    <td><input type="checkbox" name="checkboxes[]" value="32" /><?php echo ($list['goods_id']); ?></td>

    <td class="first-cell" style=""><span ><?php echo ($list['goods_name']); ?></span></td>
    <td><span ><?php echo ($list['goods_sn']); ?></span></td>
    <td align="right"><span ><?php echo ($list['shop_price']); ?>
    </span></td>
    ...
    <td align="center"><span ><?php echo ($list['click_count']); ?></span></td>
        <td align="right"><span ><?php echo ($list['goods_number']); ?></span></td>
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/Public/Admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/Goods/goodsEdit',array('goods_id'=>$list['goods_id']));?>" title="编辑"><img src="/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/Goods/goodsDel',array('goods_id'=>$list['goods_id']));?>"  title="回收站"><img src="/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
